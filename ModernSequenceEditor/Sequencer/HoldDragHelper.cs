...
namespace WDE.ModernSequenceEditor
{
    public class HoldDragHelper
    {
        ...
        {
            int snapTime = SequenceEditor.ViewSettings.TimeSignatureList.Snap(time - Offset, int.MaxValue);
            ...
            {
                Do(new ClearAction(Sequence, draggedPatternInitialTime, SequenceEditor.ViewSettings.TimeSignatureList.GetBarLengthAt(draggedPatternInitialTime)));
            }
            ...
            if (snapTime != draggedPatternPreviousTime)
            {
                ...
                {
                    Do(new ClearAction(Sequence, draggedPatternPreviousTime, SequenceEditor.ViewSettings.TimeSignatureList.GetBarLengthAt(draggedPatternInitialTime)));
                }
